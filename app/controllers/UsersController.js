...
class UsersController {
    ...
    static async addUser(req, res){
        ...
        let result = await UserORM.create({username: req.body.username, password: req.body.password, avatar: req.body.avatar})
    ...
    static async updateUser(req, res){
        ...
        let result = await UserORM.update({ username: req.body.username, password: req.body.password, avatar: req.body.avatar }, {
            where: {
                id: uid
            }
        })
